...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-6 col-xs-12" id="week-counts1"></div>
                <div class="col-md-6 col-xs-12" id="class-counts1"></div>
            </div>
        </section>
        <section class="content">
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <h3 class="box-title">Most Like</h3>
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <h3 class="box-title">Most DisLike</h3>
                            <div class="box-tools pull-right">
                                <ul class="pagination pagination-sm inline">
                                    <li><a href="#">&laquo;</a></li>
                                    <li><a href="#">1</a></li>
...
<script src="adminJS/js/adminArticle.js"></script>
