        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message -->
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="adminJS/dist/img/user2-160x160.jpg" class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
                                            Support Team
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="adminJS/dist/img/user3-128x128.jpg" class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="adminJS/dist/img/user4-128x128.jpg" class="img-circle"
                                                 alt="User Image">
                                        </div>
                                        <h4>
                                            Developers
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="adminJS/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="admin/admin_index"><i class="fa fa-wechat"></i> 聊天</a></li>
                    <li><a href="admin/admin_index"><i class="fa fa-envelope"></i> 留言</a></li>
                    <li><a href="admin/admin_index"><i class="fa fa-calendar-check-o"></i> 活动通知</a></li>
                </ul>
            </li>
        </ul><!-- /.sidebar-menu -->
