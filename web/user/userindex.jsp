...
<head>
  <meta charset="utf-8">
  <title>
    <s:if test="#session.className == 'index' ">
      推荐
    </s:if>
    <s:elseif test="#session.className == 'remen' ">
      热点
    </s:elseif>
  ...
  <div class="articles">
    ...
    <s:iterator value="#session.articles" var="myArticles" status="status">
      <s:if test="#myArticles[3].toString() != ''">
        <div class="singlePicArticle" id="${myArticles[0]}"><div class="tiltePicDiv"><img class="titlePic" src="${myArticles[3]}" /></div><div class="title"><h4>${myArticles[1]}</h4></div><div class="content">${myArticles[2]}</div><div class="fct">${myArticles[4]}</div><div class="fct">　·　${myArticles[6]}条评论　·　</div><div class="fct">${myArticles[5].toString().substring(0,10)}</div><div class="lds">${myArticles[9]}<img title="shoucang" class="agree" src="./img/iconfont-icon.png"></div><div class="lds">${myArticles[8]}<img class="agree" title="cai" src="./img/iconfont-zanzan-copy.png"></div><div class="lds">${myArticles[7]}<img class="agree" title="zan" src="./img/iconfont-zanzan1.png"></div></div>
        <%--<div class="singlePicArticle" id="${myArticles[0]}"><div class="tiltePicDiv"><img class="titlePic" src="${myArticles[3]}" /></div><div class="title"><h4>${myArticles.[1]}</h4></div><div class="content">${myArticles[2]}</div><div class="fct">${myArticles[4]}</div><div class="fct">　·　${myArticles[6]}评论　·　</div><div class="fct">${myArticles[5].toString().substring(0,10)}</div><div class="lds">${myArticles[9]}<img class="agree" title="shoucang" src="img/iconfont-icon.png"></div><div class="lds">${myArticles[8]}<img class="agree" title="cai" src="img/iconfont-zanzan-copy.png"></div><div class="lds">${myArticles[7]}<img title="zan" class="agree" src="img/iconfont-zanzan1.png"></div></div>--%>
      </s:if>
      <s:else>
        <div class="singlePicArticle" id="${myArticles[0]}"><div class="title"><h4>${myArticles[1]}</h4></div><div class="content">${myArticles[2]}</div><div class="fct">${myArticles[4]}</div><div class="fct">　·　${myArticles[6]}条评论　·　</div><div class="fct">${myArticles[5].toString().substring(0,10)}</div><div class="lds">${myArticles[9]}<img title="shoucang" class="agree" src="./img/iconfont-icon.png"></div><div class="lds">${myArticles[8]}<img class="agree" title="cai" src="./img/iconfont-zanzan-copy.png"></div><div class="lds">${myArticles[7]}<img class="agree" title="zan" src="./img/iconfont-zanzan1.png"></div></div>
      </s:else>
    </s:iterator>

    <nav>
      <ul class="pagination">
          <li ><a href="news_${session.className}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
          <s:if test="#session.currentPage <= 3 || #session.pageCounts <= 7">
            <s:iterator value="{1,2,3,4,5,6,7}" status="status">
              <s:if test="#status.index < #session.pageCounts">
                ...
                <s:else>
                  <li ><a href="news_${session.className}?page=<s:property />"><s:property /> </a></li>
                </s:else>
              </s:if>
            </s:iterator>
          </s:if>
          ...
          <li><a href="news_${session.className}?page=<s:property value="#session.pageCounts" />" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
      </ul>
    </nav>
