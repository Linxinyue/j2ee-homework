...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content" id="myCustom">
                ...
                <div class="col-md-2 col-xs-6">
                    <div class="input-group">
                        ...
                        <s:if test="#session.modArticle != null">
                            <input type="text" class="form-control" placeholder="id" id="id" value="${session.modArticle.article_id}">
                        </s:if>
                        <s:else>
            ...
            <div id="displayConent">
                <s:include value="articleModConent.jsp" />
            </div>
            <div class="row">
...
<script src="adminJS/js/adminArticleMod.js"></script>
